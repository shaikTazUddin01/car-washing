...
//service slots
router.post("/slots", (0, auth_1.auth)('admin'), (0, validationRequest_1.default)(ServiceValidation_1.serviceValidation.slotValidationSchema), services_controller_1.serviceController.createSlot);
